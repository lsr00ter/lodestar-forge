...
export function CreateUser() {
  ...
  const addUserHandler = async () => {
    ...
    const result = await addUser(name, email, role, password, confirmPassword);
    if (result) {
      setName("");
      setEmail("");
      setRole("");
    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete the form below to create a new user. Required fields are
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              type="password"
              className={confirmPasswordError ? "border border-red-500" : ""}
