...
export function CreateIntegration() {
  ...
  const addIntegrationHandler = async () => {
    ...
    const result = await addIntegration(name, integration, keyId, secretKey);
    if (result) {
      setName("");
      setIntegration("");
      setKeyId("");
    ...
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Complete the form below to add a new integration. Required fields
        ...
        <div className="grid gap-4">
          ...
          <div className="grid gap-2">
            ...
            {integration === "tailscale" && (
              <p className="text-amber-500 text-xs">
                Tailscale API keys expire every 90 days. Be sure to keep this
                value up to date.
              </p>
            )}
          ...
          {integration === "aws" && (
            <div className="grid gap-2">
              ...
              <Input
                ...
                value={keyId}
                className={keyIdError ? "border border-red-500" : ""}
          ...
          <div className="grid gap-2">
            ...
            <Input
              ...
              value={secretKey}
              type="password"
              className={secretKeyError ? "border border-red-500" : ""}
