...
export function ConfigurationCard({
    ...
    const FileVariablesNextButton = () => {
        ...
        selectedFiles.forEach((selectedFile) => {
            ...
            selectedFilesHaveVariables = file?.variables.length > 0;
        });
                    ...
                    onClick={() => {
                        const newVariables = variables.map((variable) => {
                            if (variable.type === "file") {
                                const fileVariables =
                                    files.find((f) => f.id === variable.value)
                                        ?.variables || [];
            ...
            <CardHeader className="flex flex-row items-center justify-between">
                <div>
                    ...
                    <CardDescription className="text-xs text-muted-foreground mt-1.5">
                        Add and modify configuration templates for your
                        infrastructure.
                    </CardDescription>
                </div>
                <div
                                            ...
                                            <DialogContent>
                                                ...
                                                <DialogFooter>
                                                    <div className="w-full flex flex-row justify-between items-center">
                                                        <Button
                                                            onClick={() => {
                                                                setShowFileVariables(
                                                                    false,
                                                                );
                                                                setShowTemplateVariables(
                                                                    false,
                                                                );
                                                                setDialogOpen(
                                                                    false,
