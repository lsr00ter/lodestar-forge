          ...
          <div className="flex gap-2 flex-row">
            {(() => {
              const hasConfigurations = infrastructure.some(
                (i) => i.configurations !== null && i.configurations.length > 0,
              );

              const resources = infrastructure.flatMap((i) => i.resources);

              const hasTailscaleIps = resources.every((resource) => {
                ...
                case "ready-to-deploy":
                  return (
                    <Button
                      ...
                      disabled={
                        infrastructure.filter((i) => i.status !== "default")
                          .length < 1
                      }
                      size="sm"
                    >
                  ...
                  return (
                    <TooltipProvider>
                      ...
                      {!hasConfigurations || !hasTailscaleIps ? (
                        ...
                        <Button
                          onClick={() => configureDeployment(deployment?.id)}
                          size="sm"
                          disabled={!hasConfigurations || !hasTailscaleIps}
                        >
                          Configure
                        </Button>
                      )}
