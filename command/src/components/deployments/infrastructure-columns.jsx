      ...
      if (privateIps.length > 1)
        return (
          <TooltipProvider>
            <Tooltip>
              <TooltipTrigger>
                <p className="underline decoration-dashed">Multiple</p>
              </TooltipTrigger>
              <TooltipContent>
                <p className="max-w-[100px]">{privateIps.join(", ")}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        );
        ...
        return (
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent>
                <p className="max-w-[100px]">{publicIps.join(", ")}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        );
          ...
          >
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  Deleting infrastructure will permanently remove it and all
