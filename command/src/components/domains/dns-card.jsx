                ...
                <div className="items-top flex space-x-2">
                  ...
                  <div className="grid gap-1.5 leading-none">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Automatically fetch DNS records for a domain.
                      <br />
                      Warning, this option will override any custom records.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid gap-2">
            <Tabs defaultValue="a" className="">
              ...
              <TabsContent value="a" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={aRecords} />
                </div>
              </TabsContent>
              <TabsContent value="aaaa" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={aaaaRecords} />
                </div>
              </TabsContent>
              <TabsContent value="cname" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={cnameRecords} />
                </div>
              </TabsContent>
              <TabsContent value="mx" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={mxRecords} />
                </div>
              </TabsContent>
              <TabsContent value="ns" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={nsRecords} />
                </div>
              </TabsContent>
              <TabsContent value="ptr" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={ptrRecords} />
                </div>
              </TabsContent>
              <TabsContent value="soa" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={soaRecords} />
                </div>
              </TabsContent>
              <TabsContent value="srv" className="h-full">
                <div>
                  <DataTable columns={dnsColumns} data={srvRecords} />
                </div>
              </TabsContent>
              <TabsContent value="txt">
                <div>
                  <DataTable columns={dnsColumns} data={txtRecords} />
                </div>
              </TabsContent>
            </Tabs>
          </div>
