...
export const columns = [
  ...
  },
  {
    ...
    header: ({ column }) => (
      <DataTableColumnHeader column={column} title="Virus Total Category" />
    ),
    cell: ({ row }) => {
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction asChild>
                  <Button
                    onClick={() => {
                      archiveDomain(row.original.id, row.original.projectId);
            ...
            <AlertDialogContent>
              ...
              <AlertDialogFooter>
                ...
                <AlertDialogAction asChild>
                  <Button
                    onClick={() => {
                      deleteDomain(row.original.id, row.original.projectId);
            ...
            <DropdownMenuContent align="end">
              ...
              {row.original.state !== "archived" && (
                <>
                  <DropdownMenuItem
                    onClick={() =>
                      router.push(`/dashboard/domains/${row.original.id}`)
                    }
                  >
                    More Information
                  </DropdownMenuItem>
              ...
              {row.original.state === "archived" ? (
                <DropdownMenuItem
                  onClick={() => {
                    unarchiveDomain(row.original.id, row.original.projectId);
                  }}
                >
                  Unarchive
                </DropdownMenuItem>
          ...
          >
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Are you absolutely sure?</AlertDialogTitle>
                <AlertDialogDescription>
                  Deleting a DNS record will permanently remove it and all
                  associated data.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                ...
                <AlertDialogAction asChild>
                  <Button
                    onClick={() => {
                      deleteDnsRecord(row.original.domainId, row.original.id);
                      setDeleteDialogOpen(false);
                    }}
                    className="h-9"
                  >
