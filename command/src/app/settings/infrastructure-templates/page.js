...
import { columns } from "@/components/settings/infrastructure/columns";
import { CreateTemplate } from "@/components/settings/infrastructure/create-template";
...
export default async function InfrastructureTemplates() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium">Infrastructure Templates</h3>
